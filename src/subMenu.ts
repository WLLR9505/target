...
export function standardMenu(menu: string[], submenu: string[], control: Controls, color: string) : Controls {
                    ...
                    for (let i2 = 0; i2 < subTam; i2++) {
                        if (i2 == control.pos2) {
                            ...
                            if (i == control.pos1) {
                                ...
                                process.stdout.write(`${colors[6][1]}${menu[i]}${colors[15][1]}\t\t\t`);
                                process.stdout.write(`${colors[6][2]}${submenu[i2]}${colors[15][1]}\n`);
    ...
    function updateMenu() {
        for (var i2 = 0; i2 < menu.length; i2++) {
            if (control.pos1 == i2) {
                console.log(`${c[0][2]} ${menu[i2]} ${colors[15][1]}`);//marca posição do seletor
            } else {
                console.log(`${menu[i2]}`);
            }
        }
